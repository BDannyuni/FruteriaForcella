<div class="container-fluid">
    ...
    <div class="row">
        ...
        <h5 style="display: inline" class="card-title fw-semibold mb-4">Total de Ventas del Mes </h5>
        <button style="display: inline" id="TotalDeVentas" type="button" class="btn btn-info m-1 "></button><br>
    </div><br>
    ...
    success: function(respuesta) {
        ...
        for (let i = 0; i < respuesta.length; i++) {
            filas = '<tr>' +
                ...
                '<td class="border-bottom-0"><h6 class="fw-semibold mb-0 fs-4">$' + respuesta[i][
                    'total_venta'
                ] + '</h6></td>' +
                '</tr>'
...
$.ajax({
    ...
    method: 'POST',
    data: {
        'accion': 2, //parametro para obtener los Productos mas vendidos
    },
    dataType: 'json',
    success: function(respuesta) {
        console.log("respuesta", respuesta);
        ...
        $("#card-title").html('Ventas Mas Populares');
