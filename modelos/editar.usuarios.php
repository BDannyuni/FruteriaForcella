...
<body style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../vistas/assets/images/backgrounds/agregar.jpg) ; background-size:cover;">
    ...
    if(isset($_POST["editar2"])){
        ...
        $query="UPDATE usuarios SET nombre_completo=?,correo=?,usuario=?,contra=?,tipo=? WHERE id=?";
        $sentencia=mysqli_prepare($getconex,$query);
        mysqli_stmt_bind_param($sentencia,"ssssii",$nombre_usuario,$correo_usuario,$usuario,$contra_usuario,$tipo_usuario,$id_usuario);
    ...
    <div class="body-wrapper">
        ...
        <div class="container-fluid"><br><br>
            <h1 class="text-white">Editar Usuario</h1><br><br>
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="editar.usuarios.php" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $id_usuario ?>"
                                        name="id_usuario">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Nombre del Proveedor</label>
                                    <input type="text" class="form-control" value="<?php echo $nombre_usuario ?>"
                                        name="nombre_completo_usuario">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">No. Telefono</label>
                                    <input type="text" class="form-control" value="<?php echo $correo_usuario ?>"
                                        name="correo_usuario">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Correo Electronico</label>
                                    <input type="text" class="form-control" value="<?php echo $contra_usuario ?>"
                                        name="contra_usuario">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="card-tools offset-lg-3" style="display: inline">
                                    <input class='btn btn-success' type="submit" name="editar2" value="Editar Usuario">
                                    <button class="btn btn-danger m-2"><a style="cursor: pointer;"
                                            class="sidebar-link text-white" href="../index2.php">Regresar</a></button>
                                </div>
